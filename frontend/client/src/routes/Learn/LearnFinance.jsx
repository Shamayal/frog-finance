  ...
  return (
    <div className="wrapper learn-section font-quicksand">
      ...
      <div className="tip-row">
        ...
        <div data-aos="fade-up-left" data-aos-duration="500" className="tip-picture finance-pic1"></div>
      </div>

      <br />

      <div className="tip-row">
        <div data-aos="fade-up-right" data-aos-duration="500" className="tip-picture finance-pic2"></div>
      ...
      <div className="tip-row">
        ...
        <div data-aos="fade-up-left" data-aos-duration="500" className="tip-picture finance-pic3"></div>
      </div>

      <br />

      <div className="tip-row">
        <div data-aos="fade-up-right" data-aos-duration="500" className="tip-picture finance-pic4"></div>
        <div data-aos="fade-up-left" data-aos-duration="500" className="tip-box">
      ...
      <div className="tip-row">
        ...
        <div data-aos="fade-up-left" data-aos-duration="500" className="tip-picture finance-pic5"></div>
      </div>

      <br />

      <div className="tip-row">
        <div data-aos="fade-up-right" data-aos-duration="500" className="tip-picture finance-pic6"></div>
        <div data-aos="fade-up-left" data-aos-duration="500" className="tip-box">
      ...
      <div className="tip-row">
        ...
        <div data-aos="fade-up-left" data-aos-duration="500" className="tip-picture finance-pic7"></div>
      </div>

      <br />

      <div className="tip-row">
        <div data-aos="fade-up-right" data-aos-duration="500" className="tip-picture finance-pic8"></div>
        <div data-aos="fade-up-left" data-aos-duration="500" className="tip-box">
