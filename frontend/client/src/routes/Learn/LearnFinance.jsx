const LearnFinance = () => {
  return (
    <div>
      <h1>A Guide to the Basics of Financial Literacy</h1>
      <br />
      <h3>Dive into the pond of financial wisdom!</h3>
      <br />
      <h5>Financial literacy is a term thrown around a lot, but what is it and how important is it in your daily life?</h5>
      <p>
