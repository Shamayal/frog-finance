  ...
  return (
    <div className="wrapper learn-section font-quicksand">
      ...
      <div className="tip-row">
        ...
        <div data-aos="fade-up-left" data-aos-duration="500" className="tip-picture money-pic1"></div>
      </div>

      <br />

      <div className="tip-row">
        <div data-aos="fade-up-right" data-aos-duration="500" className="tip-picture money-pic2"></div>
      ...
      <div className="tip-row">
        ...
        <div data-aos="fade-up-left" data-aos-duration="500" className="tip-picture money-pic3"></div>
      </div>

      <br />

      <div className="tip-row">
        <div data-aos="fade-up-right" data-aos-duration="500" className="tip-picture money-pic4"></div>
        <div data-aos="fade-up-left" data-aos-duration="500" className="tip-box">
      ...
      <div className="tip-row">
        ...
        <div data-aos="fade-up-left" data-aos-duration="500" className="tip-picture money-pic5"></div>
      </div>
